...
\minor{``The first'', ``the added support'', ``the form of''}
...
\minor{``The second''}
\assignment{$\uparrow$ The reader does not know at this point what ``Team
Projects'' mean, so maybe explain it in a more descriptive way, including
the improvements you have done}

We also introduce other concepts like Improved Submissions and Assignments Dashboard.
\assignment{$\uparrow$ In which way the submissions have been improved?
Plus, add another sentence summarizing what is benefit of these
improvements}
